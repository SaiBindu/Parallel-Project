		...
		public void menu() {
			...
			case 2:
				...
				try {
					...
					System.out.print("Account balance in " + customer.getName());
					System.out.println(" account is " + customer.getWallet());
			...
			case 3:
				...
				try {
					...
					System.out.println("Account balance is: " + customer.getWallet());
			...
			case 5:
				...
				try {
					...
					System.out.println("And now your balance is " + customer.getWallet());
